/datum/species/anthromorph
	...
	default_features = list("mcolor" = "FFF", "tail_human" = "None", "ears" = "None", "wings" = "None", "horns" = "None", "body_markings" = "None")
	mutant_bodyparts = list("ears", "tail_human","horns","body_markings")
	use_skintones = FALSE
